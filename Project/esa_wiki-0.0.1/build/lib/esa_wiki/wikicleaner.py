...
namespaces = {'help', 'file talk', 'module', 'topic', 'mediawiki', 'wikipedia talk', 'file', 'user talk', 'special', 'category talk', 'category', 'media', 'wikipedia', 'book', 'draft', 'book talk', 'template', 'help talk', 'timedtext',
              'mediawiki talk', 'portal talk', 'portal', 'user', 'module talk', 'template talk', 'education program talk', 'education program', 'timedtext talk', 'draft talk', 'talk'}
...
discard_elements = {'gallery', 'timeline', 'noinclude', 'pre', 'table', 'tr', 'td', 'th', 'caption', 'form', 'input', 'select', 'option', 'textarea', 'ul', 'li', 'ol', 'dl', 'dt', 'dd', 'menu', 'dir', 'ref', 'references', 'img', 'imagemap',
                    'source'}
...
selfclosing_tags = {'br', 'hr', 'nobr', 'ref', 'references'}
...
ignored_tags = {'a', 'b', 'big', 'blockquote', 'center', 'cite', 'div', 'em', 'font', 'h1', 'h2', 'h3', 'h4', 'hiero', 'i', 'kbd', 'nowiki', 'p', 'plaintext', 's', 'small', 'span', 'strike', 'strong', 'sub', 'sup', 'tt', 'u', 'var'}
